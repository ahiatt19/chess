...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_DARK_GREEN = SET_BG_COLOR + "121m";
    public static final String SET_BG_COLOR_LIGHT_GREEN = SET_BG_COLOR + "115m";
    public static final String SET_BG_COLOR_START_SQUARE = SET_BG_COLOR + "37m";
